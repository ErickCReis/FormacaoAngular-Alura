...
describe(PhotoFrameComponent.name, () => {
  ...
  it(`#${PhotoFrameComponent.prototype.like.name}
   should trigger (@Output liked) once called
   multiple times within dedbouce time`, fakeAsync(() => {
  ...
  it(`#${PhotoFrameComponent.prototype.like.name}
   ...
   outside debouce time`, fakeAsync(() => {
    fixture.detectChanges();
    let times = 0;
    component.liked.subscribe(() => times++);
    component.like();
  ...
  it(`(D) Should display with img and description when bound to property`, () => {
